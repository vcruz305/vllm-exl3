...
import typing
from decoder_tail import slice_decoder_tail
...
class DeepseekV4Model(nn.Module, EagleModelMixin):
    ...
    def forward(
        ...
        for idx, layer in enumerate(
            ...
            if idx == 21:
                (hidden_states, positions, input_ids, pre_mix, post_mix, res_mix,
                 residual, engram_hashes, engram_mask) = slice_decoder_tail(
                    self, hidden_states, positions, input_ids, pre_mix, post_mix,
