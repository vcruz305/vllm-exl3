            ...
            for mode in [CUDAGraphMode.PIECEWISE, CUDAGraphMode.FULL]:
                ...
                for desc in descs:
                    ...
                    if (
                        ...
                        from graph_runtime import lease_current_graph
                        lease_current_graph(self, graph, desc)
...
class ModelCudaGraphManager(CudaGraphManager):
    ...
    def capture(
        ...
        def create_forward_fn(
            ...
            from graph_runtime import prepare_capture
            prepare_capture(self, desc, model, model_inputs, attn_metadata, slot_mappings, input_buffers.is_padding[:num_tokens])
            return forward_fn
