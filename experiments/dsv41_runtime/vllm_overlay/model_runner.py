...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def execute_model(
        ...
        if batch_desc.cg_mode == CUDAGraphMode.FULL:
            ...
            from graph_runtime import prepare_replay
            prepare_replay(self.cudagraph_manager, batch_desc, self.model, model_inputs, attn_metadata, slot_mappings_by_layer, input_batch.is_padding)
